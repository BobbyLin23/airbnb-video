...
import Counter from "../inputs/Couter"
...
const SearchModal = () => {
  ...
  const onSubmit = useCallback(async () => {
    ...
    searchModel.onClose()
    router.push(url)
  }, [location, guestCount, roomCount, bathroomCount, dateRange, params, onNext, step, router, searchModel])
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading title="More infomartion?" subtitle="Find the perfect place!"/>
        ...
        <Counter title="Bathrooms" subtitle="How many bathrooms are coming?" value={bathroomCount} onChange={(value) => setBathroomCount(value)}/>
      </div>
      )
  }
